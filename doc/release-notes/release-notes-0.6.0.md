...
Skidoo-Qt can display and save QR codes for sending
...
versions of Skidoo-Qt/bitcoind.
...
Skidoo-Qt's initial splash screen
...
opening/launching Skidoo-Qt is available only on Linux,
and only if you configure your desktop to launch
Skidoo-Qt. All platforms support dragging and dropping
bitcoin: URIs onto the Skidoo-Qt window to start
payment.
...
It is expected that future releases of Skidoo-Qt
