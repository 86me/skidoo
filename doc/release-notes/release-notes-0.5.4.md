...
Fix Skidoo-Qt notifications under Growl 1.3.
Increase required age of Skidoo-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Skidoo-Qt over it. (Windows)
