...
bitcoind/bitcoin-cli binaries are not included in the Skidoo-Qt.app bundle.

If you are building `bitcoind` or `Skidoo-Qt` for others, your build machine should be set up
...
Once dependencies are compiled, see [doc/release-process.md](release-process.md) for how the Skidoo-Qt.app
