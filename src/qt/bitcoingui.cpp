...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    overviewAction = new QAction(SingleColorIcon(":/icons/overview"), tr("&μῆλον τῆς Ἔριδος"), this);
    overviewAction->setStatusTip(tr("Glance upon thine Chao"));
    overviewAction->setToolTip(overviewAction->statusTip());
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);

    sendCoinsAction = new QAction(SingleColorIcon(":/icons/send"), tr("&Push Skidoo"), this);
    sendCoinsAction->setStatusTip(tr("Pass Chaos to a mate"));
    ...
    receiveCoinsAction = new QAction(SingleColorIcon(":/icons/receiving_addresses"), tr("&Cop Skidoo"), this);
    receiveCoinsAction->setStatusTip(tr("If worship doesn't pay, perhaps five tons of flax"));
    ...
    historyAction->setStatusTip(tr("A record of Chao taken and given"));
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About Skidoo"), this);
    aboutAction->setStatusTip(tr("Show information about Skidoo"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Skidoo"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Skidoo addresses to prove you own them"));
    verifyMessageAction = new QAction(TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Skidoo addresses"));

    openRPCConsoleAction = new QAction(TextColorIcon(":/icons/debugwindow"), tr("&Console"), this);
    openRPCConsoleAction->setStatusTip(tr("Bank by Text"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Skidoo help message to get a list with possible Skidoo command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Skidoo") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Skidoo network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    switch (blockSource) {
        case BLOCK_SOURCE_NETWORK:
            progressBarLabel->setText(tr("Gazing in to the Abyss..."));
            break;
        case BLOCK_SOURCE_DISK:
            progressBarLabel->setText(tr("Shining the Golden Apple..."));
            break;
        case BLOCK_SOURCE_REINDEX:
            progressBarLabel->setText(tr("Reticulating Splines..."));
            break;
        case BLOCK_SOURCE_NONE:
            // Case: not Importing, not Reindexing and no network connection
            progressBarLabel->setText(tr("Eris, wherefore art thou?"));
            break;
    }
    ...
    tooltip = tr("Apples shined: %n.", "", count);

    // Set icon state: spinning if catching up, tick otherwise
    if(secs < 90*60)
    {
        tooltip = tr("In the now") + QString(".<br>") + tooltip;
    ...
    else
    {
        ...
        tooltip = tr("Making hay...") + QString("<br>") + tooltip;
        if(count != prevBlocks)
        {
        ...
        tooltip += QString("<br>");
        tooltip += tr("Chaotic entropy ended: %1 ago.").arg(timeBehindText);
        tooltip += QString("<br>");
        tooltip += tr("Worship until this point irrelevant.");
    }
...
{
    QString strTitle = tr("Skidoo"); // default title
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setToolTip(tr("Reliquary is <b>encrypted</b> and currently <b>unlocked</b>"));
    ...
    case WalletModel::Locked:
        ...
        labelEncryptionIcon->setToolTip(tr("Reliquary is <b>encrypted</b> and currently <b>locked</b>"));
        encryptWalletAction->setChecked(true);
        changePassphraseAction->setEnabled(true);
        encryptWalletAction->setEnabled(false); // TODO: decrypt currently not supported
        break;
