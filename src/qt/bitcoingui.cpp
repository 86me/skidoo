    ...
    prevBlocks(0)
{
    ...
    if (!fIsTestnet)
    {
        setWindowTitle(tr("23") + " '^' " + tr("Skidoo"));
        QApplication::setWindowIcon(QIcon(":icons/bitcoin"));
        setWindowIcon(QIcon(":icons/bitcoin"));
    }
    else
    {
        setWindowTitle(tr("Skidoo") + " - " + tr("") + " " + tr("[testnet]"));
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview"), tr("&μῆλον τῆς Ἔριδος"), this);
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Push Skidoo"), this);
    sendCoinsAction->setStatusTip(tr("Pass some Chaos to a mate"));
    sendCoinsAction->setToolTip(sendCoinsAction->statusTip());
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Cop Skidoo"), this);
    ...
    addressBookAction = new QAction(QIcon(":/icons/address-book"), tr("&Lists of Numbers"), this);
    addressBookAction->setStatusTip(tr("List of others you've sent Skidoo too da loo"));
    ...
    quitAction = new QAction(QIcon(":/icons/quit"), tr("J&AM"), this);
    quitAction->setStatusTip(tr("If you gotta JAM..."));
    quitAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_Q));
    quitAction->setMenuRole(QAction::QuitRole);
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Skidoo"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About Skidoo"), this);
    aboutAction->setStatusTip(tr("Show information about Skidoo"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Tweaks..."), this);
    optionsAction->setStatusTip(tr("Change your Skidoo to fit yoo"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Skidoo client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Skidoo client") + " " + tr("[testnet]"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Skidoo address or malformed URI parameters."),
