...
{
    return FormatParagraph(strprintf(_("Copyright (C) 2018 The Skidoo Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(_("This is experimental software.")) + "\n" +
           "\n" +
           FormatParagraph(_("Distributed under the MIT software license")) + "\n" +
           "\n" +
           FormatParagraph(_("")) +
           "\n";
}
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Sanity check
    if (!InitSanityCheck())
        return InitError(_("Initialization sanity check failed. Skidoo is shutting down."));
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Skidoo is probably already running."), strDataDir));
#ifndef WIN32
